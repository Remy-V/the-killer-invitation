...
BACK_RULES = [
    "Votre mission à faire pour aujourd'hui se trouve au dos de cette carte. <strong>Ne divulguez en aucun cas votre mission</strong>, si quelqu'un devine votre mission, vous devez lui donner votre carte, à la seule condition qu'il n'en ait pas.",
    "En cas de réussite de votre mission, <strong>vous tuez votre cible</strong> en prenant sa carte avec sa mission actuelle. Soyez discret sur l'échange de sa carte.",
